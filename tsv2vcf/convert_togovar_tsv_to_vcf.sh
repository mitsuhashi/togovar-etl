...
DOWNLOAD_DIR=/mnt/nas05/togovar/public/downloads/release/20231107/
...
nohup cwltool --debug --cachedir cache --outdir $DOWNLOAD_DIR/grch38/frequency/vcf/tmp --log-dir logs convert_togovar_tsv_grch38_to_vcf.cwl input_togovar_tsv_grch38.yml >& nohup_logs/convert_togovar_tsv_grch38_to_vcf.log &
