...
label: convert-togovar-tsv-grch37-to-vcf-data
doc: This tools convert tsv files from TogoVar to VCF data lines. 
...
requirements:
  ...
  InitialWorkDirRequirement:
    listing:
      - entryname: convert-togovar-tsv-grch37-to-vcf-data.py
        entry: |
          import sys
          import csv
          import gzip
          ...
          def make_info(row):
            ...
            info = []
            for info_element in [rs_id, gene_symbol, jga_ngs, jga_snp, tommo, hgvd, gem_j_wga, gnomad_exomes, gnomad_genomes]:
              if info_element:
...
baseCommand: ["python","convert-togovar-tsv-grch37-to-vcf-data.py"]
