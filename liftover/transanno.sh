...
#toil-cwl-runner --logDebug --workDir ./toil_work --outdir $OUTDIR/mgend --logFile toil_logs/mgend.log transanno.cwl input_grch37_mgend.yml

cwltool --debug --cachedir cache --outdir $OUTDIR/jga_snp_imputed --log-dir logs ./transanno.cwl ./input_jga_snp_imputed.yml
